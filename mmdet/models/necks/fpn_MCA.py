...
class MultiscaleChannel1(nn.Module):
    def __init__(self, channels, num):
        ...
        self.fc1 = nn.Conv2d(channels * num, channels, kernel_size=1, padding=0)
        self.relu = nn.ReLU(inplace=True)
        self.fc2 = nn.Conv2d(channels, channels * num, kernel_size=1, padding=0)
...
class FPN_MCA(nn.Module):
    ...
    def __init__(self,
        ...
        self.ms = MultiscaleChannel1(channels=256, num=num_outs)
